...
for i, benchmark in enumerate(BENCHMARKS):
    data = pd.read_csv(f"../compaction_results/compaction_1/{benchmark}-time.csv")
...
num_iters = max(
    pd.read_csv(f"../compaction_results/compaction_1/{benchmark}-time.csv")["mode"].value_counts().max()
