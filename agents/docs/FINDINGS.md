...
Run `bash agents/run_bench.sh` and `python3 agents/benchmarks/plot.py agents/benchmarks/results.txt` to regenerate.
...
`bash agents/test_incr_observe.sh` runs 8 test files, 22 scenarios:
